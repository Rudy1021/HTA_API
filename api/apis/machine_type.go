...
func Machine_type_r(c *gin.Context) {
	var table []model.Machine_type
...
func Machine_type_one(c *gin.Context) {
	var table model.Machine_type
...
func Machine_type_c(c *gin.Context) {
	var table model.Machine_type
	c.BindJSON(&table)
...
func Machine_type_u(c *gin.Context) {
	var table model.Machine_type
	c.BindJSON(&table)
...
func Machine_type_d(c *gin.Context) {
	var table model.Machine_type
	c.BindJSON(&table)
