...
func Countersign_r(c *gin.Context) {
	var table []model.Countersign
...
func Countersign_one(c *gin.Context) {
	var table model.Countersign
...
func Countersign_c(c *gin.Context) {
	var table model.Countersign
	c.BindJSON(&table)
...
func Countersign_u(c *gin.Context) {
	var table model.Countersign
	c.BindJSON(&table)
...
func Countersign_d(c *gin.Context) {
	var table model.Countersign
	c.BindJSON(&table)
