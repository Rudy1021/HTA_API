...
func Worker_set_r(c *gin.Context) {
	var table []model.Worker_set
...
func Worker_set_one(c *gin.Context) {
	var table model.Worker_set
...
func Worker_set_c(c *gin.Context) {
	var table model.Worker_set
	c.BindJSON(&table)
...
func Worker_set_u(c *gin.Context) {
	var table model.Worker_set
	c.BindJSON(&table)
...
func Worker_set_d(c *gin.Context) {
	var table model.Worker_set
	c.BindJSON(&table)
