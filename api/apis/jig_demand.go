...
func Jig_demand_r(c *gin.Context) {
	var table []model.Jig_demand
...
func Jig_demand_one(c *gin.Context) {
	var table model.Jig_demand
...
func Jig_demand_c(c *gin.Context) {
	var table model.Jig_demand
	c.BindJSON(&table)
...
func Jig_demand_u(c *gin.Context) {
	var table model.Jig_demand
	c.BindJSON(&table)
...
func Jig_demand_d(c *gin.Context) {
	var table model.Jig_demand
	c.BindJSON(&table)
