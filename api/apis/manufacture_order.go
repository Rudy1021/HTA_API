...
func Manufacture_order_r(c *gin.Context) {
	var table []model.Manufacture_order
...
func Manufacture_order_one(c *gin.Context) {
	var table model.Manufacture_order
...
func Manufacture_order_c(c *gin.Context) {
	var table model.Manufacture_order
	c.BindJSON(&table)
...
func Manufacture_order_u(c *gin.Context) {
	var table model.Manufacture_order
	c.BindJSON(&table)
...
func Manufacture_order_d(c *gin.Context) {
	var table model.Manufacture_order
	c.BindJSON(&table)
...
func findAll(table string) (result *gorm.DB) {
	switch table {
	case "table":
		var tables []model.Manufacture_order
