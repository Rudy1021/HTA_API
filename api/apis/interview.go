...
func Interview_r(c *gin.Context) {
	var table []model.Interview
...
func Interview_one(c *gin.Context) {
	var table model.Interview
...
func Interview_c(c *gin.Context) {
	var table model.Interview
	c.BindJSON(&table)
...
func Interview_u(c *gin.Context) {
	var table model.Interview
	c.BindJSON(&table)
...
func Interview_d(c *gin.Context) {
	var table model.Interview
	c.BindJSON(&table)
