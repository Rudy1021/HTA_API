...
func Machine_work_place_r(c *gin.Context) {
	var table []model.Machine_work_place
...
func Machine_work_place_one(c *gin.Context) {
	var table model.Machine_work_place
...
func Machine_work_place_c(c *gin.Context) {
	var table model.Machine_work_place
	c.BindJSON(&table)
...
func Machine_work_place_u(c *gin.Context) {
	var table model.Machine_work_place
	c.BindJSON(&table)
...
func Machine_work_place_d(c *gin.Context) {
	var table model.Machine_work_place
	c.BindJSON(&table)
...
func findAll(table string) (result *gorm.DB) {
	switch table {
	case "table":
		var tables []model.Machine_work_place
